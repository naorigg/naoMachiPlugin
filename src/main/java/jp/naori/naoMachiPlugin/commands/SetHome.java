...
import jp.naori.naoMachiPlugin.commands.events.SetHomeEvents;
import jp.naori.naoMachiPlugin.commands.utils.SetHomeUtils;
...
public class SetHome extends JavaPlugin implements CommandExecutor { // --- SetHome is a JavaPlugin (Bukkit plugin)
